<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add_Stores.aspx.cs" Inherits="master_piece.Add_Stores" %>
...
<body>
    <form id="form1" runat="server">
       <div class="big_div">
            <div class="div_add"><br /><br />
                <h1>Add Stores</h1><br />
                  <asp:TextBox ID="TextPrice" runat="server" CssClass="textbox" placeholder="Store Name"  ></asp:TextBox><br /><br /><br />
                ...
                <asp:Button ID="Button_Add" runat="server" Text="Add Store" CssClass="btn_Add" /><asp:Button ID="Button_show" runat="server" Text="Show All Store" CssClass="btn_Show" />
